...
def show(frame_id, hdf5_file, sub):
    ...
    sub.clear()
    sub.scatter(
        sun_and_planets_position[0][0] / AU,
        sun_and_planets_position[1][0] / AU,
        sun_and_planets_position[2][0] / AU,
        s=100,
        marker='o',
        c='yellow')
    # Planets
    sub.scatter(
        sun_and_planets_position[0][1:] / AU,
        sun_and_planets_position[1][1:] / AU,
        sun_and_planets_position[2][1:] / AU,
        s=5,
        marker='o',
        c='blue')
    ...
    # Asteroids
    sub.scatter(
        asteroids_position[0][1:] / AU,
        asteroids_position[1][1:] / AU,
        asteroids_position[2][1:] / AU,
        s=.1,
        marker='.',
        c='green')
